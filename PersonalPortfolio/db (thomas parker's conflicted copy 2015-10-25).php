...
function db_s_House_addProperty($maxOvernightGuests,$address,$description,$suburb,$state,$postcode,$numCarParks,$numBath){
	try{
		$pdo = db_connect();	
		...
		$stmt = $pdo->prepare(		
			...
			'call add_property_s_house(:maxOvernightGuests,:address,:description,:suburb,:state,:postcode,:numCarParks,:numBath);'
				);
