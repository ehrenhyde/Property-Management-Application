...
<?php
	...
	list($result2,$count)= db_getallimages($propertyId);
    echo '<div id=content>';
		echo('[');
															foreach($poi as $result) {
																echo ("'".$result."', ");
															...
															echo("'Test']");
		echo($addressMap);
		?><br><br>['1 Longlands St Woolloongabba, QLD 4102', '2 Sword St Woolloongabba, QLD 4102']
				
	<div class="col-xs-offset-2"><div class="col-sm-9">
		<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title"><?php echo ''.$result['address'].'';?></h3>
					<?php
