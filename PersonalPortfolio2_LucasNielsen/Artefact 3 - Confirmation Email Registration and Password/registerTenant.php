...
/*enable mail*/
include ('includes/functions/mail.php'); // Inserted this line
$errors = array();
...
if (isset($_POST['submit'])){
	...
	if (!$errors){
		...
		mail_send_registration_code($confirmCode,$_POST['email'],$_POST['fullname'],$_POST['firstName'],0); // Inserted this line of code
