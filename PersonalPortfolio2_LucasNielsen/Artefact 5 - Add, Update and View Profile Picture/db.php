...
}//Modified db_addTenant_temp function and tenant_temp table
...
//Modified this function and stored procedure
...
//Modified this function and included stored procedure
...
function db_getFavouriteWHouses($loginId,$offset=0,$rowsPerPage=99999){
	$pdo = db_connect();
	try{
	
		
		$toPrepare = 'call fetch_fav_w_houses(:loginId,:offset,:rowsPerPage)';
...
function db_getFavouriteSHouses($loginId,$offset=0,$rowsPerPage=99999){
	$pdo = db_connect();
	try{
	
		$toPrepare = 'call fetch_fav_s_houses(:loginId,:offset,:rowsPerPage)';
