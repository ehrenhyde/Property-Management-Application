...
<form class= 'regForm' enctype="multipart/form-data" action = "registerOwner.php" method = "POST" name = "registerOwnerAccount"><!--Modified this line-->
<table class="table">

	<tbody>
<tr><td>Profile Picture</td><td><input type="file" name="user_files" id="user_files" tabindex='1'></td></tr><!--Inserted this line-->
