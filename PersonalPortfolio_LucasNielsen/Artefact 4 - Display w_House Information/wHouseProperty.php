...
<?php
	...
	$id=(isset($_GET["data"])) ? (int)$_GET["data"] : 1; // fetch passed propertyid data from url


	$result = db_getWHouseDetails($id); // search for property using id

			
    echo '<div id=content>';
		
		
		//display data of property from sql query 
