...
<div class="col-xs-offset-2"><div class="col-sm-9">
	...
	<div class="panel-body">
		...
		<table class="table">
			...
			<tr><td>Image 1</td><td><input class="files" name="user_files[]" type="file" multiple="multiple" tabindex='9'></td><td></td></tr>	

			<tr><td></td><td><div align="right"><?php ctrl_submit('Save',null,10); ?><!--<button class="btn btn-sm btn-primary" type="submit" value="Send" id="submit" >Save</button>--></div> <br></td></tr>
	...
	if (!$errors){
		...
		if (count($_FILES["user_files"]) > 0) {	
			...
			foreach ($filearray as $row){
				...
				$type = $row['type'];	
				db_uploadnewimage($sHouseId['propertyId'],$type,$image);
			}		
		} 
