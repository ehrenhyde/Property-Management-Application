...
<html lang="en">
<head>
	<title>Favourite Whole Houses</title>
...
<center>
	...
	$numRowsTotal = count(db_getFavouriteWHouses($loginId,0,99999));
	...
	/*WholeHouse*/
	$results = db_getFavouriteWHouses($loginId,$offset,$rowsPerPage);
